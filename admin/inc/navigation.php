...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-dark text-sm shadow-sm">
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=products" class="nav-link nav-products">
                        <img class="nav-icon" src="<?= base_url.('dist/img/helmet-icon.png') ?>">
                        <p>
                          Helmet List
                        </p>
                      </a>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=inquiry" class="nav-link nav-inquiry">
                        ...
                        <?php 
                        $inquiries_unread = $conn->query("SELECT * FROM `inquiry_list` where `status` = 0")->num_rows;
                        $inquiries_unread = $inquiries_unread > 0 ? number_format($inquiries_unread) : '';
                        ?>
                        <p>
                          Inquiries <span class="badge badge-danger"><?= $inquiries_unread ?></span>
                        </p>
                      </a>
                    </li>
